            ...
            <div class="row">
              <div class="col-md-6 pr-1">
                <div class="form-group">
                  ...
                  placeholder="min Salary" value="{{ old('minSalary',$job->minSalary) }}" 
                  required />
              ...
              <div class="col-md-6 pl-1">
                <div class="form-group">
                  ...
                  placeholder="max Salary" value="{{ old('maxSalary',$job->maxSalary) }}" 
                  required />
              ...
              <div class="col-md-4 pr-1">
                <div class="form-group">
                  ...
                  <select class="form-control" name="type" required>
                    ...
                    {{ $job->type=="Partial-Time" ? 'selected' : '' }}
                    >partial-time</option>
                    <option value="From-Home"
                    {{ $job->type=="From-Home" ? 'selected' : '' }}
                    >from-home</option>
                </select>
              ...
              <div class="col-md-4 px-1">
                <div class="form-group">
                  ...
                  <select class="form-control" name="catogry_id" required>
                    ...
                    @foreach ($cats as $cat)
                    <option value="{{ $cat->id }}" 
                    {{ $job->catogry->name == $cat->name ? 'selected' : '' }}
                    >{{ $cat->name }}</option>
                    @endforeach
              ...
              <div class="col-md-4 pl-1">
                <div class="form-group">
                  ...
                  class="form-control" placeholder="Last Date for Applay"
                   name="lastDate" value="{{ old('lastDate',$job->lastDate) }}"
                   required
                  />
            ...
            <div class="row mt-5">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  value="{{ old('requiredKnowledge',$job->requiredKnowledge) }}"
                   placeholder="requirment">
                   {{ old('requiredKnowledge',$job->requiredKnowledge) }}</textarea>
                ...
                <div class="form-group">
                  <label class="required">Education</label>
                    ...
                    value="{{ old('education',$job->education) }}"
                     placeholder="requirment">
                     {{ old('education',$job->education) }}</textarea>
