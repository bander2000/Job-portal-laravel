...
<main>
                                ...
                                <div class="select-form">
                                    <div class="select-itms">
                                        <select name="location" id="select1">
                                            ...
                                            <option value="{{ $jobLocation->location }}">
                                                {{ $jobLocation->location }}</option>
                                            @endforeach
                ...
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                    <div class="single-services text-center mb-30">
                        <div class="services-ion">
                            <span class="flaticon-{{ $cat->icon }}"></span>
                        </div>
                        <div class="services-cap">
                           <h5><a href="{{ route('cat.show',$cat->id) }}">{{ $cat->name }}</a></h5>
                            <span>({{ $cat->job_count }})</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="browse-btn2 text-center mt-50">
                        <a href="{{ route('cats') }}" class="border-btn2">Browse All Sectors</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Online CV Area Start -->
     <div class="online-cv cv-bg section-overly pt-90 pb-120" 
      data-background="{{ asset('assets/img/hero/cv.jpg') }}" 
            ...
            <div class="row justify-content-center">
                <div class="col-xl-10">
                    <div class="cv-caption text-center">
                        ...
                        <a href="{{ route('employee.profile') }}" class="border-btn2 border-btn4">Upload your cv</a>
                    </div>
                </div>
            </div>
        </div>
